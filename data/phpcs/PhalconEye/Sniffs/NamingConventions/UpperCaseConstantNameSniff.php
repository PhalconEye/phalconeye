 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PhalconEye_Sniffs_NamingConventions_UpperCaseConstantNameSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$openBracket]['code'] !== T_OPEN_PARENTHESIS) {
            ...
            if (in_array($tokens[$prevPtr]['code'], array(T_PRIVATE, T_PROTECTED, T_PUBLIC)) || $tokens[$prevPtr]['code'] === T_AS) {
                return;
            }
