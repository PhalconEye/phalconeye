...
use Core\Form\Admin\Package\FieldSet\WidgetFieldSet;
 ...
 */
class PackageCreateForm extends CoreForm
{
    const
        /**
    ...
    protected function _addElements()
    {
        ...
        $this->addFieldSet(new WidgetFieldSet(self::FIELDSET_WIDGET));
    }
    ...
    public function isValid($data = null, $skipEntityCreation = true)
    {
        ...
        if (PackageModel::findFirst($condition)) {
