...
class PackagesController extends AbstractBackofficeController
{
     ...
     * @return void
     *
     * @Route("/libraries", methods={"GET"}, name="backoffice-packages-libraries")
     */
     ...
     * @return void
     *
     * @Route("/upload", methods={"GET", "POST"}, name="backoffice-packages-upload")
     */
                ...
                if (!$manifest->isUpdate) {
                    ...
                    if ($manifest->get('dependencies')) {
                        ...
                        foreach ($dependencies as $dependency) {
                            ...
                            if ($needPackage) {
                                $packageDependency = new PackageDependencyModel();
                ...
                if ($manifest->type == Manager::PACKAGE_TYPE_MODULE) {
                    ...
                    if (!empty($manifest->i18n)) {
                        foreach ($manifest->i18n as $languageData) {
                            LanguageModel::parseImportData($this->getDI(), $languageData->toArray());
                        }
                    }
     ...
     * @return mixed
     *
     * @Route("/create", methods={"GET", "POST"}, name="backoffice-packages-create")
     */
     ...
     * methods={"GET", "POST"},
     * name="backoffice-packages-events"
     * )
     */
     ...
     * methods={"GET", "POST"},
     * name="backoffice-packages-export"
     * )
     */
    public function exportAction($type, $name)
    {
        $package = $this->_getPackage($type, $name);
        if (!$package) {
            return $this->response->redirect(['for' => 'backoffice-packages']);
        }
     ...
     * methods={"GET"},
     * name="backoffice-packages-uninstall"
     * )
     */
    ...
    {
        return PackageModel::findByType($type, null, 'enabled DESC');
    }
     ...
     * @return bool
     */
    protected function _hasDependencies(PackageModel $package)
    {
     ...
     * @return void
     */
    protected function _setWidgetData(CoreForm $form, PackageModel $package, $data)
    {
        ...
        if ($widget->module) {
            ...
            $dependency = new PackageDependencyModel();
