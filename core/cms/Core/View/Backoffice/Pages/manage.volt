                        ...
                        <li>
                            <div id="layout_select_block">
                                ...
                                <ul class="admin_layoutbox_menu_columnchoices_thumbs">
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant
                                        ('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_LEFT')~'.png') }}"
                                             alt="3 columns"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_LEFT') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_MIDDLE_LEFT')~'.png') }}"
                                             alt="2 columns - Left"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_MIDDLE_LEFT') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE')~'.png') }}"
                                             alt="2 columns - Right"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE') }}');">
                                    </li>
                                    <li>
                                ...
                                <ul class="admin_layoutbox_menu_columnchoices_thumbs">
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_TOP_RIGHT_MIDDLE_LEFT')~'.png') }}"
                                             alt="3 columns"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_TOP_RIGHT_MIDDLE_LEFT') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_TOP_MIDDLE_LEFT')~'.png') }}"
                                             alt="2 columns - Left"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_TOP_MIDDLE_LEFT') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_TOP_RIGHT_MIDDLE')~'.png') }}"
                                             alt="2 columns - Right"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_TOP_RIGHT_MIDDLE') }}');">
                                    </li>
                                    <li>
                                ...
                                <ul class="admin_layoutbox_menu_columnchoices_thumbs">
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_LEFT_BOTTOM')~'.png') }}"
                                             alt="3 columns"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_LEFT_BOTTOM') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_MIDDLE_LEFT_BOTTOM')~'.png') }}"
                                             alt="2 columns - Left"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_MIDDLE_LEFT_BOTTOM') }}');">
                                    </li>
                                    <li>
                                        <img src="{{ static_url('assets/application/img/module/Core/backoffice/content/'~constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_BOTTOM')~'.png') }}"
                                             alt="2 columns - Right"
                                             onclick="changeCurrentLayoutType('{{ constant('\Core\Model\PageModel::LAYOUT_RIGHT_MIDDLE_BOTTOM') }}');">
                                    </li>
                                    <li>
