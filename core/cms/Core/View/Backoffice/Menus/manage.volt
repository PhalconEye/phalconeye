...
{% block head %}
    {{ helper('assets').addJs('application/js/core/backoffice/menu.js') }}
    {{ helper('assets').addJs('application/js/core/widgets/modal.js') }}
    {{ helper('assets').addJs('application/js/core/widgets/ckeditor.js') }}

    <script type="text/javascript">
        var menuItemsData = {
            'menu_id': {{ menu.id }},
            'link_create': '{{ url(['for':'backoffice-menus-create-item'])}}',
            'link_edit': '{{ url(['for':'backoffice-menus-edit-item'])}}',
            'link_delete': '{{ url(['for':'backoffice-menus-delete-item'])}}',
            'link_order': '{{ url(['for':'backoffice-menus-order'])}}'
