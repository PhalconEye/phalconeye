...
{{ partial("Core/View/partials/profiler/window", ['name':'config', 'title':'Phalcon Eye Config', 'content':htmlConfig]) }}
{{ partial("Core/View/partials/profiler/window", ['name':'router', 'title':'Router', 'content':htmlRouter]) }}
{{ partial("Core/View/partials/profiler/window", ['name':'memory', 'title':'Memory', 'content':htmlMemory]) }}
{{ partial("Core/View/partials/profiler/window", ['name':'time', 'title':'Time', 'content':htmlTime]) }}
{{ partial("Core/View/partials/profiler/window", ['name':'files', 'title':'Files', 'content':htmlFiles]) }}
{{ partial("Core/View/partials/profiler/window", ['name':'sql', 'title':'SQL', 'content':htmlSql]) }}
