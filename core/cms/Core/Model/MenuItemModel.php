 ...
 *
 * @Source("menu_items")
 * @BelongsTo("menu_id", '\Core\Model\MenuModel', "id", {
 *  "alias": "MenuModel"
 * })
 * @BelongsTo("parent_id", '\Core\Model\MenuItemModel', "id", {
 *  "alias": "MenuItemModel"
 * })
 * @HasMany("id", "\Core\Model\MenuItemModel", "parent_id", {
 *  "alias": "MenuItemModel"
 * })
 *
 * @method static \Core\Model\MenuItemModel findFirst($parameters = null)
 */
class MenuItemModel extends AbstractModel
{
    ...
    {
        return $this->getRelated('MenuModel', $arguments);
    }
     ...
     *
     * @return MenuItemModel|MenuModel
     */
    public function getParent()
    {
        if ($this->parent_id) {
            ...
            return MenuModel::findFirst($this->menu_id);
        }
    }
