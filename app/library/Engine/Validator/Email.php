...
class Validator_EmailAddress extends Validator_Abstract
{
     ...
     * These bitfields are defined by the ALLOW_* constants in Validator_Hostname
     * The default is to allow DNS hostnames only
     *
     * @param integer                $allow             OPTIONAL
     * @param bool                   $validateMx        OPTIONAL
     * @param Validator_Hostname $hostnameValidator OPTIONAL
     * @return void
     */
    public function __construct($allow = Validator_Hostname::ALLOW_DNS, $validateMx = false, Validator_Hostname $hostnameValidator = null)
    {
     ...
     * @return void
     */
    public function setHostnameValidator(Validator_Hostname $hostnameValidator = null, $allow = Validator_Hostname::ALLOW_DNS)
    {
        if ($hostnameValidator === null) {
            $hostnameValidator = new Validator_Hostname($allow);
        }
    ...
    public function isValid($value)
    {
        ...
        if (!$hostnameResult) {
            ...
            if ($this->validateMxSupported()) {
                ...
                throw new Validator_Exception('Internal error: MX checking not available on this system');
            }
        }
