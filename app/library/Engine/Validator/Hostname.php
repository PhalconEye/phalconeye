...
class Validator_Hostname extends Validator_Abstract
{
     ...
     * @param Validator_Ip $ipValidator OPTIONAL
     * @return void
     * @see http://www.iana.org/cctld/specifications-policies-cctlds-01apr02.htm  Technical Specifications for ccTLDs
     */
    public function __construct($allow = self::ALLOW_DNS, $validateIdn = true, $validateTld = true, Validator_Ip $ipValidator = null)
    {
        // Set allow options
        $this->setAllow($allow);
     ...
     * @return void;
     */
    public function setIpValidator(Validator_Ip $ipValidator = null)
    {
        if ($ipValidator === null) {
            $ipValidator = new Validator_Ip();
        }
     ...
     *
     * @param  integer $allow
     * @return Validator_Hostname Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @throws Validator_Exception if a fatal error occurs for validation process
     * @return boolean
     */
    public function isValid($value)
    {
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                     ...
                     * @see Validator_Hostname_Interface
                     */
                    ...
                    foreach ($domainParts as $domainPart) {
                        ...
                        foreach($regexChars as $regexKey => $regexChar) {
                            ...
                            if ($status === false) {
                                ...
                                throw new Validator_Exception('Internal error: DNS validation failed');
                            } elseif ($status !== 0) {
                                $length = 63;
        ...
        if (false === $status) {
             ...
             */
            // require_once 'Zend/Validate/Exception.php';
            throw new Validator_Exception('Internal error: local network name validation failed');
        }
