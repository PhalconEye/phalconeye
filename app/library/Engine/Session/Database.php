 ...
 */
class Session_Database extends \Phalcon\Session\Adapter implements \Phalcon\Session\AdapterInterface
{
    ...
    public function __construct($options = null)
    {
        ...
        if (!isset($options['db'])) {
            throw new \Phalcon\Session\Exception("The parameter 'db' is required");
        }

        if (!isset($options['table'])) {
            throw new \Phalcon\Session\Exception("The parameter 'table' is required");
        }
