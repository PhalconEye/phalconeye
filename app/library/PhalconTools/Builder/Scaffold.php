...
class Scaffold extends Component
{
	...
	public function build()
	{
        ...
        if (isset($this->_options['namespace'])) {
           $options['namespace'] = $this->_options['namespace'];
        }
        ...
        if (!isset($this->_options['modelsDir'])) {
            ...
            $options['modelsDir'] = $path . $this->_options['modelsDir'];
        }
        ...
        if (!isset($this->_options['controllersDir'])) {
            ...
            $options['controllersDir'] = $path . $this->_options['controllersDir'];
        }

        if (!isset($this->_options['viewsDir'])) {
            ...
            $options['viewsDir'] = $path . $this->_options['viewsDir'];
        }
		...
		$modelClass = $options['namespace']."\Models\\" . Text::camelize($name);
		$modelPath = $options['modelsDir'].'/'.Text::camelize($name).'.php';
		if (!file_exists($modelPath)) {
			...
			$modelBuilder = new \Phalcon\Builder\Model(array(
                ...
                'namespace' => $options['namespace']."\Models",
	...
	private function _makeController($path, $options)
	{
		...
		if (!file_exists($controllerPath)) {
            ...
            "namespace ".$options['namespace']."\Controllers;".PHP_EOL.PHP_EOL.
			'use \Phalcon\Tag as Tag;'.PHP_EOL.PHP_EOL.
			'class '.$options['className'].'Controller extends '.Tools::getWebToolsConfig()->controllerBaseClass . PHP_EOL."\t".'{'.PHP_EOL.PHP_EOL.
			//Index
